...
multi_fasta <- adegenet::fasta2DNAbin("diptera_accession.fasta")
# Warning message:
...
input <- read.FASTA("diptera_accession.fasta", type = "DNA")
...
write.fas(output2, file = "alignment/diptera_coi_mafft_aligned.fasta") # fasta better resembles web version's
write.nex(output2, file = "alignment/diptera_coi_mafft_aligned.nex", taxblock = TRUE)
